...
<body onload="load();">
    <div id="content">
        <div id="browser">
            <div id="div">
                <div class="dashcode-header-backbutton div1_template" id="div1"></div>
            </div>
            <div id="div2"><div id="view1">
                    <div id="text"></div>
                </div><div id="view2"></div></div>
        </div>
        <textarea id="textarea" onclick="myClickHandler(event)"></textarea>
    </div>
    <div id="footer"></div>
</body>
</html>
